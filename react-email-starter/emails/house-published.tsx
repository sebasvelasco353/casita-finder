...
export const HousePublishedEmail = ({
  ...
  return (
    ...
    >
      ...
      <Button
        className="w-full bg-primary text-white rounded-full font-bold text-white text-md text-center py-2 box-border my-2"
        href={publishedLink}
      >
...
const Footer = () => {
  return (
    <Text className="text-xs text-pretty text-mutedForeground">
      Este enlace no expira: úsalo cuando quieras para cambiar el estado de tu
      casita o eliminar el anuncio.
    </Text>
  );
};
